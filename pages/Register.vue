        ...
        <div class="right col-4">
            <div class="register">
                ...
                <form action="/Register">
                    ...
                    <input type="password" placeholder="Confirm Password" class="mb-4">

                    <button class="btn w-100" type="submit">Sign Up</button>
                </form>
            </div>
            <nuxt-link to="/SignIn">
                <p class="sign-in mt-3 text-center">I already have an account</p>
            </nuxt-link>
        </div>
    </div>
  </div>
...
input {
    ...
    &:focus, &:active {
        border: var(--blue-hover) 1px solid;
    }
}
